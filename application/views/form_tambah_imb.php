...
<div id="container">
	...
	<div id="body">
		...
		<?php echo form_open('imb/tambah_imb') ?>
		...
		<table>
			...
			<tr>
			      <td>Lokasi</td>
			      <td>:</td>
			      <td><?php echo form_input('lokasi', set_value('lokasi')); ?> </td>
			</tr>
			<tr>
			      <td>Luas</td>
			      <td>:</td>
			      <td><?php echo form_input('luas', set_value('luas')); ?> </td>
			</tr>
			<tr>
			      <td>Fungsi</td>
			      <td>:</td>
			      <td><?php echo form_input('fungsi', set_value('fungsi')); ?> </td>
			</tr>
			<tr>
			      <td>Status</td>
			      <td>:</td>
			      <td><?php echo form_input('status', set_value('status')); ?> </td>
			</tr>
